...
class BaristaProductRepository {
  BaristaProductRepository({ApiClient? client}) : _client = client ?? ApiClient();

  final ApiClient _client;

  Future<List<Product>> fetchProducts({required String token}) async {
    final json = await _client.getJson('/api/barista/products', token: token);
  ...
  Future<void> setAvailability({
    ...
    await _client.patchJson(
      '/api/barista/products/$productId/availability',
